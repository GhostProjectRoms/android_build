...
""" % bcb_dev)
  ...
  script.Print("SPPAOSPPAO      PPA          OSPPAO      PPAO  P  SPPAOSPPAO ")    
  script.Print(" AOSPPAOSPP    PAOSP        SPPAOSPP   PPAOSPPAOS  AOSPPAOSPP ")  
  script.Print(" SPPA    AOS   OSPPA       PPAO  PAOS PAOSP  OSPP  SPPA    AOS ")  
  script.Print(" PAOSPPAOSPP  SPPAOS       AOS    SPP OSPPA        PAOSPPAOSPP ")  
  script.Print(" OSPPAOSPPA   PAO PPA     OSPP    PAOS PAOSP       OSPPAOSPPA ")   
  script.Print(" PPAOSPPAO   AOSPPAOSP    PPAO    OSPP    PAOSP    PPAOSPPAO ")    
  script.Print(" AOS         SPPAOSPPA     OSP    PPA      SPPA    AOS ")          
  script.Print(" SPP        PPAO   AOSP    PPA    AOS       AOSP   SPP ")         
  script.Print(" PAO        AOS     PPA    AOSP  OSPP OSPP  SPPA   PAO ")         
  script.Print("AOSPPA    AOSPPA   PAOSPP   PPAOSPPA  PPAOSPPAOS  AOSPPA ")      
  script.Print("SPPAOS    SPPAOS   OSPPAO    OSPPAO   AOSPPAOSP   SPPAOS ")                                                                         
  script.Print("                                                     ")
