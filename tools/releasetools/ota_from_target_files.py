...
""" % bcb_dev)
  ...
  script.Print(" _______  _______  _______  _______  _______ ")
  script.Print("(  ____ )(  ___  )(  ___  )(  ____ \(  ____ )")
  script.Print("| (    )|| (   ) || (   ) || (    \/| (    )|")
  script.Print("| (____)|| (___) || |   | || (_____ | (____)|")
  script.Print("|  _____)|  ___  || |   | |(_____  )|  _____)")
  script.Print("| (      | (   ) || |   | |      ) || (      ")
  script.Print("| )      | )   ( || (___) |/\____) || )      ")
  script.Print("|/       |/     \|(_______)\_______)|/       ")                                                                        
  script.Print("                                             ")
  script.Print("               paosp.github.io               ")
  script.Print("                                             ")
  script.Print("*********************************************")
  script.Print("                                             ")
